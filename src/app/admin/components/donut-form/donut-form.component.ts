    ...
    <form class="donut-form" #form="ngForm">
      <label>
        ...
        <input
          ...
          #name="ngModel" />
        @if (name.invalid && name.touched) { @if (name.errors?.['minlength']) {
      ...
      <label>
        ...
        @if (icon.invalid && icon.touched && icon.errors?.['required']) {
      ...
      <label>
        ...
        @if (price.invalid && price.touched && price.errors?.['required']) {
      ...
      <button type="button" class="btn btn--grey" (click)="form.resetForm({ name: 'Initial state' })">
        Reset Form
      </button>
